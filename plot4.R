...
# Create four plots and send them to a file
par(mfrow=c(2,2), mar=c(4,4,2,1))

plot(sub_hpower$Date_Time, sub_hpower$Global_active_power, type="l", xlab="", ylab="Global Active Power")

plot(sub_hpower$Date_Time, sub_hpower$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(sub_hpower$Date_Time, sub_hpower$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
